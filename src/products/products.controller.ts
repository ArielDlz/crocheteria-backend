...
export class ProductsController {
  ...
  @ApiQuery({ name: 'includeInactive', required: false, type: Boolean, description: 'Incluir productos inactivos' })
  @ApiQuery({ name: 'onlyInactive', required: false, type: Boolean, description: 'Mostrar solo productos inactivos' })
  ...
  @Delete(':id/permanent')
  @RequirePermissions('products:delete')
  @ApiOperation({ summary: 'Eliminar permanentemente un producto (irreversible)' })
  @ApiResponse({ status: 200, description: 'Producto eliminado permanentemente' })
  @ApiResponse({ status: 404, description: 'Producto no encontrado' })
